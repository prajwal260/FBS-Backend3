...
public class ScheduledFlightTest {
	/**
	  ...
	  public final void testEquals() throws NullPointerException {
		  ...
		  Flight flight= new Flight(new Integer("101"),"C101","M101",200);
		  Schedule schedule= new Schedule(new Integer("1"),airport1,airport2,"12-06-2020","13-06-2020");
		  ScheduledFlight sFlight1 = new ScheduledFlight();
		  assertNotNull(sFlight1);
		  ScheduledFlight sFlight2 = null;
		  ScheduledFlight sFlight3= new ScheduledFlight(new Integer("101"),flight,120,schedule);
		  ScheduledFlight sFlight4= new ScheduledFlight(new Integer("101"),flight,120,schedule);
	  ...
	  public final void testToString() {
		  ...
		  Flight flight= new Flight(new Integer("101"),"C101","M101",200);
		  Schedule schedule= new Schedule(new Integer("1"),airport1,airport2,"12-06-2020","13-06-2020");
		  ScheduledFlight sFlight1= new ScheduledFlight(new Integer("101"),flight,120,schedule);
